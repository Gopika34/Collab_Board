    ...
    return (
        <div className="bg-sidebar border-b border-border">
            <div className='flex justify-between items-center container mx-auto px-6 py-4'>
                <h1 className='text-2xl font-bold text-text-primary'>CollabBoard</h1>
                <button className='rounded-lg px-5 py-2 flex items-center gap-1 active:scale-95
                    bg-accent hover:bg-accent-hover text-text-primary font-medium transition-all duration-200'
